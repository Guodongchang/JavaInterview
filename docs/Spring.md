...
1.Springboot 对微服务的功能支持  如zookeeper
...
你说你熟悉SpringBoot，请介绍一下Springboot的一些特点，以及如何修改它的内置Tomcat的配置？
...
简要介绍dubbo 然后了解过spring cloud吗？区别在于哪

springcloud用过吗？和dubbo区别？哪个快？



### 简述springcloud核心组件及用途   // 这个不会只写了一个断路器

### （加分）SprignCloud限流实现  （写的不会但用过Guava的RateLimiter）
